...
func TestNormalizeConfigRejectsStaticKeysThatResolveToOrderedKeys(t *testing.T) {
	...
	patterns := []struct {
		...
		{name: "ordered queue", get: func(cfg queueclient.Config) string { return cfg.OrderedQueuePattern }},
		{name: "ordered lease", get: func(cfg queueclient.Config) string { return cfg.OrderedLeasePattern }},
	}
