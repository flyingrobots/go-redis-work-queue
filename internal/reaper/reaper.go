...
func (r *Reaper) scanOnce(ctx context.Context) {
    ...
    for {
        ...
        if err != nil { r.log.Warn("reaper scan error", obs.Err(err)); return }
        cursor = cur
