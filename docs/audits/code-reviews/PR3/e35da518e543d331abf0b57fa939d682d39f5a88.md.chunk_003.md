...
> ## Regression Avoidance Strategy
>
> Keep manifests templated or validated with `kubectl --dry-run=client` before merge.
>
> ## Notes
>
...
> | Confidence | Remarks |
> |------------|---------|
> | 8 | Alert and dashboard now reference the canonical `rate_limit_exceeded_total` metric. |
>
> ## Lesson Learned
>
> Consistent metric names prevent drift across alerts and dashboards.
>
> ## What did you do to address this feedback?
>
> Renamed the alert query and Grafana panel in `deployments/kubernetes/monitoring.yaml:109-116` and `:205-212` to use `rate_limit_exceeded_total`.
>
> ## Regression Avoidance Strategy
>
> Extend Prometheus rule linting/checks to flag mismatched metric aliases.
>
> ## Notes
>
> String-only change; Prometheus lint pending.
